...
class _CityListState extends State<CityList>
{
          ...
          (
            ...
            (
              ...
              [
                ...
                Center
                (
                  child: Padding(padding: const EdgeInsets.only(top: 20), child: Text("Şehirler burada listelenecektir.",style: TextStyle(color: Colors.white,fontSize: 15)),
                  )
                )
                else SafeArea
                (
 ...
 _listItem(index)
  {
    String trKontrol = _sehirlerGoruntu[index].ulkeAd == "Turkey" ? "Türkiye" : _sehirlerGoruntu[index].ulkeAd;
