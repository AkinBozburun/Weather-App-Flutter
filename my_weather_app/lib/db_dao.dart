import 'dart:async';
import 'package:my_weather_app/db_yardimcisi.dart';
...
class SehirlerDAO
{
  Future<List<SehirlerList>> sehirOku() async
  {
    ...
    List<Map<String, dynamic>> maps = await db.rawQuery("SELECT * From sehirList");
    ...
    (
      maps.length, (index)
      {
        ...
        return SehirlerList(satir["sehir_id"], satir["sehir_ad"], satir["ulke_kod"], satir["lat"], satir["long"]);
      }
    );
  }
